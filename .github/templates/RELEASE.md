<!-- This doc is updated and synced from https://github.com/conda/infrastructure -->
...
Per CEP-8 a release is scheduled to be cut during the week of the second Monday of the month. At the very latest, the release outlined here should start a week earlier, this effectively means that the release process starts at the first week of the month.

### 1. Open the Release Issue (~1 week before release week).
