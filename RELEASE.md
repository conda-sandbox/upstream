...
[epic template]: https://github.com/conda-sandbox/upstream/issues/new?assignees=&labels=epic&template=epic.yml
[compare]: https://github.com/conda-sandbox/upstream/compare
[new release]: https://github.com/conda-sandbox/upstream/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/upstream-feedstock
[conda-forge]: https://github.com/conda-forge/upstream-feedstock
...
Placeholder for `upstream YY.M.x` release.
...
[milestone]: https://github.com/conda-sandbox/upstream/milestone/<milestone>
[process]: https://github.com/conda-sandbox/upstream/blob/main/RELEASE.md
[releases]: https://github.com/conda-sandbox/upstream/releases
[main]: https://github.com/AnacondaRecipes/upstream-feedstock
[conda-forge]: https://github.com/conda-forge/upstream-feedstock
[ReadTheDocs]: https://readthedocs.com/projects/continuumio-upstream/
...
- [ ] Ensure release candidates are being successfully built (see `conda-canary/label/rc-upstream-YY.M.x`)
...
Once the release PRs are filed, successful canary builds will be available on `https://anaconda.org/conda-canary/conda/files?channel=rc-upstream-YY.M.x` for manual testing.
...
2. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    (rever) $ git clone git@github.com:/upstream.git
    (rever) $ cd conda
    ```
